...
def last_uav_move_strategy(uav_speed, uav_max_speed, uav_deceleration_speed, enemy_speed, max_distances, detect_distances, uavpoint, basepoint, enemy_center, acceleration):
    ...
    return last_begin_turn_dms, after_turning_last_uav_dms, chase_uav_dms, meet_last_enemy_dms, chase_enemy_dms, turning_time, chase_time_val, after_chase_time
...
if __name__ == "__main__":
    ...
    last_begin_turn_dms, after_turning_last_uav_dms, chase_uav_dms, meet_last_enemy_dms, chase_enemy_dms, turning_time, chase_time, after_chase_time = last_uav_move_strategy(
    ...
    first_uav_sorted = first_sorted_y_points(data['first_uavs'], first_uav_center, data['enemy_approx'])
